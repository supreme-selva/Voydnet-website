/* ==========================================================================
   COMPONENT CONTROLLER: feature-protect
   --------------------------------------------------------------------------
   Composes the second section: the "one tap, all protected" illustration on
   the left, and the headline + copy on the right.
...
export function mount(root, props = {}) {
  ...
  if (img) {
    img.src = ASSETS.oneTapProtectedIllustration;
    img.alt = t("protect.headline", "Protected in one tap.");
  }
